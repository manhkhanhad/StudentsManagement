...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 24, 2021 at 08:52 AM
...
CREATE TABLE IF NOT EXISTS `chitietbangdiem` (
  `MaChiTietBangDiem` varchar(23) NOT NULL,
  `MaBangDiem` varchar(15) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `lop` (
  ...
  `SLDLop` decimal(3,2) NOT NULL DEFAULT '0',
  `TLDLop` decimal(3,2) NOT NULL DEFAULT '0',
  PRIMARY KEY (`MaLop`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `lop` (`MaLop`, `TenLop`, `Khoi`, `SiSo`, `SLDLop`, `TLDLop`) VALUES
('10A1', '10A1', '10', 30, '0', '0'),
('10A2', '10A2', '10', 30, '0', '0'),
('10A3', '10A3', '10', 30, '0', '0'),
('11A1', '11A1', '11', 30, '0', '0'),
